...
We can evaluate NMDS stress using different vegetation abundance transformations and compare these to the raw abundance stress. Next, we'll use a normalize transformation using the **decostand** function from the vegan R package. We'll then create an NMDS ordination and stress plot.
...
const_abund(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_2,clusnum = 1,const_thresh=60)

## Constancy/cover - Cluster 2
const_abund(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_2,clusnum = 2,const_thresh=60)

# Explore cluster 2 plots

# Compare the 2 PAM clusters to the 2 hclust clusters
table(fec_vegfor_log_pam_2$clustering,fec_vegfor_log_hc_cut_avg_2)
...
```{r}
## Constancy/cover Cluster 1
const_abund(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_4,clusnum = 1,const_thresh=60)

## Constancy/cover Cluster 2
const_abund(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_4,clusnum = 2,const_thresh=60)

## Constancy/cover Cluster 3
const_abund(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_4,clusnum = 3,const_thresh=60)

## Constancy/cover Cluster 4
const_abund(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_4,clusnum = 4,const_thresh=60)

# Compare the 2 PAM clusters to the 4 hclust clusters
table(fec_vegfor_log_pam_2$clustering,fec_vegfor_log_hc_cut_avg_4)
...
# Hclust 2 clusters
table(fec_envfor$ecoregion_title,fec_vegfor_log_hc_cut_avg_2)

# PAM 2 clusters
table(fec_envfor$ecoregion_title,fec_vegfor_log_pam_2$clustering)

# Hclust 4 clusters
table(fec_envfor$ecoregion_title,fec_vegfor_log_hc_cut_avg_4)
...
table(fec_envfor$ecosite_title,fec_vegfor_log_hc_cut_avg_2)
...
table(fec_envfor$dominanttree,fec_vegfor_log_hc_cut_avg_2)

```

More of less parallel the ecosite cross-tabulation
...
table(fec_envfor$soil_moisture_agg,fec_vegfor_log_hc_cut_avg_2)
...
table(fec_envfor$soil_moisture_agg,fec_vegfor_log_hc_cut_avg_4)
...
fec_vegfor_log_hclus_2_indduf <- indval(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_2)
...
fec_vegfor_log_hclus_2_ind<- multipatt(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_2, 
                    control = how(nperm=100)) 
...
fec_vegfor_log_hclus_4_ind<- multipatt(fec_vegfor_mat_lt1,fec_vegfor_log_hc_cut_avg_4, 
                    control = how(nperm=100)) 
...
row.names(fec_vegfor_mat_lt1_log)[fec_vegfor_log_pam_2$clustering == 1 & fec_vegfor_log_hc_cut_avg_2 == 2]
...
row.names(fec_vegfor_mat_lt1_log)[fec_vegfor_log_pam_2$clustering == 2 & fec_vegfor_log_hc_cut_avg_2 == 1]
...
# Hclust clusters
fec_vegfor_log_hc_cut_avg_2_dunn <- dunn(fec_vegfor_mat_lt1_dist_bc_log,fec_vegfor_log_hc_cut_avg_2)
fec_vegfor_log_hc_cut_avg_2_dunn
...
The function clustvar() quantifies the amount of compositional variation (i.e. beta diversity) observed among the sites belonging to each cluster ([De Cáceres and Wiser 2024](https://emf-creaf.github.io/vegclust/articles/VegetationClassification.html)). Lower variability indicates more compact and less variable clusters.
...
# Hclust clusters
clustvar(fec_vegfor_mat_lt1_dist_bc_log,fec_vegfor_log_hc_cut_avg_2)
...
# hclust clustering
fec_vegfor_log_hc_cut_avg_2_sil <- silhouette(fec_vegfor_log_hc_cut_avg_2, fec_vegfor_mat_lt1_dist_bc_log)
x11()
plot(fec_vegfor_log_hc_cut_avg_2_sil,main="Silhouette Diagram for the hclust clusters")
summary(fec_vegfor_log_hc_cut_avg_2_sil)

# Export the results

# First add row names

row.names(fec_vegfor_log_hc_cut_avg_2_sil) <- fec_envfor$plotnumber

# Export to a CSV file
write.csv(fec_vegfor_log_hc_cut_avg_2_sil,"test.csv")
...
orglpoints(fec_upfor_nmds_bc_log$points[fec_vegfor_log_hc_cut_avg_2 == 1,],display="sites",color="darkgreen",radius=.010) 
orglpoints(fec_upfor_nmds_bc_log$points[fec_vegfor_log_hc_cut_avg_2 == 2,],display="sites",color="orange",radius=.010) 

# Test significance of the distribution of hclust 2 clusters along the ordination axes

ordtest(fec_upfor_nmds_bc_log_dsv,fec_vegfor_log_hc_cut_avg_2)
...
orglpoints(fec_upfor_nmds_bc_log$points[fec_vegfor_log_hc_cut_avg_4 == 1,],col="darkgreen",radius=.010)
orglpoints(fec_upfor_nmds_bc_log$points[fec_vegfor_log_hc_cut_avg_4 == 2,],col="orange",radius=.010)
orglpoints(fec_upfor_nmds_bc_log$points[fec_vegfor_log_hc_cut_avg_4 == 3,],col="blue",radius=.010)
orglpoints(fec_upfor_nmds_bc_log$points[fec_vegfor_log_hc_cut_avg_4 == 4,],col="red",radius=.010)

# Test significance of the distribution of hclust 4 clusters along the ordination axes

ordtest(fec_upfor_nmds_bc_log_dsv,fec_vegfor_log_hc_cut_avg_4)
```
...
surf_org <- ordisurf(fec_upfor_nmds_bc_log_dsv,fec_envfor$depth_of_organic_matter_cm,choices = c(1, 2))
points(fec_upfor_nmds_bc_log_dsv,fec_vegfor_log_hc_cut_avg_4 == 1,col="darkgreen")
points(fec_upfor_nmds_bc_log_dsv,fec_vegfor_log_hc_cut_avg_4 == 2,col="orange")
points(fec_upfor_nmds_bc_log_dsv,fec_vegfor_log_hc_cut_avg_4 == 3,col="blue")
points(fec_upfor_nmds_bc_log_dsv,fec_vegfor_log_hc_cut_avg_4 == 4,col="red")
